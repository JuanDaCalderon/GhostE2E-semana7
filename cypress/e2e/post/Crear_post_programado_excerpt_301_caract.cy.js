...
import PostsPage, { validateDeletedPost } from "../../page-object/posts";

let postData = {
    title: faker.name.fullName(),
    description: faker.random.alpha(100),
    excerpt: faker.random.alpha(301)
}
...
it('Se crea un post programado digitando excerpt con 300 caracteres (frontera) - se valida que este en la lista', () => {    
    ...
    //And I check the alert message appears
    PostsPage.checkExcerptMessageAlert();
