...
describe('Escenarios tags', () => {
    it('Crear tag con nombre de menos de 191 caracteres y descripción con menos de 500 caracteres', () => {
        let i = 0
        ...
        TagsTag.cleanRecentBigTag(cy.get("h3.gh-tag-list-name").contains(tagData.name).click({force: true}));
    })
})