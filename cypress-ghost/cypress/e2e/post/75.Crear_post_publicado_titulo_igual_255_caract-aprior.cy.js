...
let postData = {
    title: PrioriDataPool.getRandomText255(),
    description: PrioriDataPool.getRandomLongSentence(),
}

const nameScreenshots = 'crear_post_publicado_p';

describe('Crear post publicado con titulo de 255 caracteres - frontera', () => {
    it('Se crea un post publicado - se valida que este en la lista - lo elimina', () => {
